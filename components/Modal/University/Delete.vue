...
const emit = defineEmits(['university-deleted']);
...
const { deleteUniversityById } = universityStore;
...
const confirmDelete = async () => {
   ...
   try {
      ...
      showToast("Universitet o'chirishda xatolik yuz berdi.", 'error');
   } finally {
      loading.value = false;
   }
};
      ...
      <Dialog v-model:open="isOpen">
         ...
         <DialogContent class="sm:max-w-[600px] p-4">
            <div class="pt-6 p-5 flex flex-col items-center">
               ...
               <p class="leading-130 text-gray-700 text-sm">Siz Universitetni o'chirmoqchimisiz?</p>
