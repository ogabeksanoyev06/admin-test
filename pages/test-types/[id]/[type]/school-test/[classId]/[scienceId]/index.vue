<template>
   <div class="flex flex-1 flex-col gap-4">
      <div class="flex items-center justify-between">
         ...
         <ModalTestUnitCreate :scienceId="route.params.scienceId" @section-added="handleAddSection" />
      </div>
            ...
            <Table>
               ...
               <TableBody>
                  <TableRow v-for="(item, i) in parts?.data" :key="i" class="odd:bg-muted/50">
                     ...
                     <TableCell class="font-medium">
                        <NuxtLink :to="`/test-types/${route.params.id}/${route.params.type}/school-test/${route.params.classId}/${route.params.scienceId}/${item._id}`" class="text-primary">
                           {{ item.name_uz }}
                        </NuxtLink>
                     </TableCell>
